...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 10,status: 200, thumbnail: fs.readFileSync(`./storage/image/thumb.jpg`), surface: 200, message: `)-----[KN-BOT]-----(`, orderTitle: 'LordRifza', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
console.log(color('Halo, selamat menggunakan KN-BOT', 'purple'))
...
start('2', 'mengoneksikan ke KNBOTV3...')
})
//
rifza.on('open', async (open) => {
console.log({open})
success('2', 'terkoneksi✔️')
setTimeout( () => {
}, 1500)
})
//
...
console.log(bgcolor('KN-BOT ©WhatsApp_Bot • Created By > [ ®MR͜͡ KiNOꪜ ]\n-------> Ready to use❗', 'gray'))
//
await sleep(3000)
